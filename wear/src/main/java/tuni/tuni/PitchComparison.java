...
/**
 * Created by kyleboss on 11/22/15.
 */
public class PitchComparison {
    private static final double PITCH_LOW_LIMIT = 20.0f;
    ...
    public static double displayNoteOf(double pitch, String noteName) {
